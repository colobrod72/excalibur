...
sleep 1s && wget https://launchpad.net/veracrypt/trunk/1.26.24/+download/veracrypt-1.26.24-Debian-13-amd64.deb && wget https://github.com/session-foundation/session-desktop/releases/download/v1.17.7/session-desktop-linux-x86_64-1.17.7.AppImage && https://github.com/OneKeyHQ/app-monorepo/releases/download/v5.20.0/OneKey-Wallet-5.20.0-linux-x86_64.AppImage
